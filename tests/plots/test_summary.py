...
def test_summary():
    ...
    fig = plt.figure()
    shap.summary_plot(np.random.randn(20, 5), show=False, rng=rng)
...
def test_summary_with_data():
    ...
    rng = np.random.default_rng(0)
    fig = plt.figure()
    shap.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), show=False, rng=rng)
    fig.set_layout_engine("tight")
    return fig
...
def test_summary_multi_class():
    ...
    rng = np.random.default_rng(0)
    fig = plt.figure()
    shap.summary_plot([np.random.randn(20, 5) for i in range(3)], np.random.randn(20, 5), show=False, rng=rng)
    fig.set_layout_engine("tight")
    return fig
...
def test_summary_multi_class_legend_decimals():
    ...
    fig = plt.figure()
    shap.summary_plot(
        [np.random.randn(20, 5) for i in range(3)], np.random.randn(20, 5), show=False, show_values_in_legend=True, rng=rng
    )
    fig.set_layout_engine("tight")
    return fig
...
def test_summary_bar_with_data():
    ...
    rng = np.random.default_rng(0)
    fig = plt.figure()
    shap.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), plot_type="bar", show=False, rng=rng)
    fig.set_layout_engine("tight")
    return fig
...
def test_summary_dot_with_data():
    ...
    rng = np.random.default_rng(0)
    fig = plt.figure()
    shap.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), plot_type="dot", show=False, rng=rng)
    fig.set_layout_engine("tight")
    return fig
...
def test_summary_violin_with_data():
    ...
    rng = np.random.default_rng(0)
    fig = plt.figure()
    shap.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), plot_type="violin", show=False, rng=rng)
    fig.set_layout_engine("tight")
    return fig
...
def test_summary_layered_violin_with_data():
    ...
    rng = np.random.default_rng(0)
    fig = plt.figure()
    shap_values = rng.randn(200, 5)
    feats = rng.randn(200, 5)
    shap.summary_plot(
        shap_values,
        feats,
...
def test_summary_with_log_scale():
    ...
    rng = np.random.default_rng(0)
    fig = plt.figure()
    shap.summary_plot(np.random.randn(20, 5), use_log_scale=True, show=False, rng=rng)
    fig.set_layout_engine("tight")
    return fig
